...
public class PostApiController {
    ...
    // 게시물 등록
    @Operation(summary = "게시물 작성", description = "게시물 작성을 담당하는 매서드 입니다.")
    @Parameters({
            @Parameter(name = "writer", description = "게시물의 작성자 이름을 쓰세요.", example = "뽀삐", required = true),
            @Parameter(name = "title", description = "게시물의 제목을 쓰세요.", example = "제목", required = true),
            @Parameter(name = "content", description = "게시물의 내용을 쓰세요.", example = "내용"),
            @Parameter(name = "hashTags", description = "게시물의 해시태그를 작성하세요.", example = "['히히','호호']")
    })
    @PostMapping
    ...
    @Operation(summary = "게시물 수정", description = "게시물 수정을 담당하는 매서드 입니다.")
    @ApiResponses(value = {
    ...
    public ResponseEntity<?> delete(@PathVariable Long id) {
        ...
        try {
            ...
            return ResponseEntity.ok().body("DEL SUCCESS!");
        }
